...
# two output layer names [first is the output probabilities - second can be used to derive the bounding box]
layerNames = [
...
# python test.py --east text_detection.pb --image images/example*.jpg --padding 0.05